...
{	
    ...
    CRedisMgr::Instance().ClearPlayerOnlineLobbySvrID(CApplication::Instance().GetServerID());
	//int iSizeCApplication = sizeof(CApplication);
	//int iSizeCDBMysqlMgr = sizeof(CDBMysqlMgr);
	//int iSizeCDataCfgMgr = sizeof(CDataCfgMgr);
	//int iSizeCGameNetMgr = sizeof(CGameNetMgr);
	//int iSizeCRedisMgr = sizeof(CRedisMgr);
	//int iSizeCPlayerMgr = sizeof(CPlayerMgr);
	//int iSizeCGobalEventMgr = sizeof(CGobalEventMgr);
	//int iSizeCServerMgr = sizeof(CServerMgr);
	//int iSizeCCenterLogMgr = sizeof(CCenterLogMgr);
	//int iSizeCGobalRobotMgr = sizeof(CGobalRobotMgr);
	//int iSizeCLobbyAsyncDBCallBack = sizeof(CLobbyAsyncDBCallBack);
	//
	//LOG_DEBUG("mem size - iSizeCApplication:%d,iSizeCDBMysqlMgr:%d,iSizeCDataCfgMgr:%d,iSizeCGameNetMgr:%d,iSizeCRedisMgr:%d,iSizeCPlayerMgr:%d,iSizeCGobalEventMgr:%d,iSizeCServerMgr:%d,iSizeCCenterLogMgr:%d,iSizeCGobalRobotMgr:%d,iSizeCLobbyAsyncDBCallBack:%d",
	//	iSizeCApplication, iSizeCDBMysqlMgr, iSizeCDataCfgMgr, iSizeCGameNetMgr, iSizeCRedisMgr, iSizeCPlayerMgr, iSizeCGobalEventMgr, iSizeCServerMgr, iSizeCCenterLogMgr, iSizeCGobalRobotMgr, iSizeCLobbyAsyncDBCallBack);
