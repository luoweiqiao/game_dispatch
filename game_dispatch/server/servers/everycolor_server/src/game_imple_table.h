...
static const int GAME_PLAYER = 6;	//最大游戏人数
...
public:
	...
	void    FlushUserBlingLogTen(CGamePlayer* pPlayer);
	void    FlushUserBlingLogHundred(CGamePlayer* pPlayer);
