...
private:
	...
	int64   CalcPlayerInfo(uint32 uid,int64 winScore, int64 lPlayerJackpotScore = 0, bool isBanker = false);

	// playerFees out : 玩家累计抽水  add by har
