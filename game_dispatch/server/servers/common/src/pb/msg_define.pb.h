...
enum PHP_MSG_ID {
  ...
  PHP_MSG_CHANGE_ROBOT_BOSS_ACCVALUE = 26,
  ...
  PHP_MSG_NOTIFY_LARGE_ALI_PAY_RECHARGE = 52,
...
enum SERVER_MSG_ID {
  ...
  L2S_MSG_UPDATE_ROBOT_OBLINE_CFG = 518,
  L2S_MSG_DELETE_ROBOT_OBLINE_CFG = 519,
...
enum DISPATCH_MSG_ID {
  ...
  LS2D_MSG_CHECK_OTHER_LOBBY_SERVER = 711,
  D2LS_MSG_CHECK_OTHER_LOBBY_SERVER = 712,
  D2S_MSG_CHANGE_ROOM_STOCK_CFG = 713,
  LD2L_MSG_SYNC_OTHER_LOBBY_PLAYER_DATA = 714
};
bool DISPATCH_MSG_ID_IsValid(int value);
const DISPATCH_MSG_ID DISPATCH_MSG_ID_MIN = LS2D_MSG_REGISTER;
const DISPATCH_MSG_ID DISPATCH_MSG_ID_MAX = LD2L_MSG_SYNC_OTHER_LOBBY_PLAYER_DATA;
...
enum CLIENT_MSG_ID {
  ...
  C2S_MSG_COMMON_JOIN_TABLE = 2038,
  S2C_MSG_COMMON_JOIN_TABLE_REP = 2039,
  ...
  S2C_MSG_NOTIFY_VIP_RECHARGE_REQ = 2055,
  S2C_MSG_NOTIFY_UNION_PAY_RECHARGE_REQ = 2056,
  S2C_MSG_NOTIFY_UNION_PAY_RECHARGE_REP = 2057,
  S2C_MSG_NOTIFY_WECHAT_PAY_RECHARGE_REQ = 2058,
  S2C_MSG_NOTIFY_WECHAT_PAY_RECHARGE_REP = 2059,
  S2C_MSG_NOTIFY_ALI_PAY_RECHARGE_REQ = 2060,
  S2C_MSG_NOTIFY_ALI_PAY_RECHARGE_REP = 2061,
  S2C_MSG_NOTIFY_OTHER_PAY_RECHARGE_REQ = 2062,
  S2C_MSG_NOTIFY_OTHER_PAY_RECHARGE_REP = 2063,
  S2C_MSG_NOTIFY_QQ_PAY_RECHARGE_REQ = 2064,
  S2C_MSG_NOTIFY_QQ_PAY_RECHARGE_REP = 2065,
  S2C_MSG_NOTIFY_WECHAT_SCAN_PAY_RECHARGE_REQ = 2066,
  S2C_MSG_NOTIFY_WECHAT_SCAN_PAY_RECHARGE_REP = 2067,
  S2C_MSG_NOTIFY_JD_PAY_RECHARGE_REQ = 2068,
  S2C_MSG_NOTIFY_JD_PAY_RECHARGE_REP = 2069,
  S2C_MSG_NOTIFY_APPLE_PAY_RECHARGE_REQ = 2070,
...
const CLIENT_MSG_ID CLIENT_MSG_ID_MAX = S2C_MSG_FISHING_NOTICE_NEW_BULLET;
