...
public:
	...
	void    DeletePlayerOnlineInfo(uint32 uid);
    ...
    // 修改游戏数据记录
    void    ChangeGameValue(uint16 gameType,uint32 uid,bool isCoin,int32 win,int32 lose,int64 winscore, int64 lExWinScore, int64 maxscore);
    // 更新最大牌型
