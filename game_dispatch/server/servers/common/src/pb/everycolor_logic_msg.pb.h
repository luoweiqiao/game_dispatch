...
class msg_everycolor_game_info_play_rep : public ::google::protobuf::Message {
 public:
  ...
  // optional bytes periods_num_ten = 12;
  inline bool has_periods_num_ten() const;
  inline void clear_periods_num_ten();
  static const int kPeriodsNumTenFieldNumber = 12;
  inline const ::std::string& periods_num_ten() const;
  inline void set_periods_num_ten(const ::std::string& value);
  inline void set_periods_num_ten(const char* value);
  inline void set_periods_num_ten(const void* value, size_t size);
  inline ::std::string* mutable_periods_num_ten();
  inline ::std::string* release_periods_num_ten();
  inline void set_allocated_periods_num_ten(::std::string* periods_num_ten);

  // optional bytes periods_num_hundred = 13;
  inline bool has_periods_num_hundred() const;
  inline void clear_periods_num_hundred();
  static const int kPeriodsNumHundredFieldNumber = 13;
  inline const ::std::string& periods_num_hundred() const;
  inline void set_periods_num_hundred(const ::std::string& value);
  inline void set_periods_num_hundred(const char* value);
  inline void set_periods_num_hundred(const void* value, size_t size);
  inline ::std::string* mutable_periods_num_hundred();
  inline ::std::string* release_periods_num_hundred();
  inline void set_allocated_periods_num_hundred(::std::string* periods_num_hundred);

  // optional uint32 game_status_ten = 14;
  inline bool has_game_status_ten() const;
  inline void clear_game_status_ten();
  static const int kGameStatusTenFieldNumber = 14;
  inline ::google::protobuf::uint32 game_status_ten() const;
  inline void set_game_status_ten(::google::protobuf::uint32 value);

  // optional uint32 game_status_hundred = 15;
  inline bool has_game_status_hundred() const;
  inline void clear_game_status_hundred();
  static const int kGameStatusHundredFieldNumber = 15;
  inline ::google::protobuf::uint32 game_status_hundred() const;
  inline void set_game_status_hundred(::google::protobuf::uint32 value);

  // optional uint32 residue_card_ten = 16;
  inline bool has_residue_card_ten() const;
  inline void clear_residue_card_ten();
  static const int kResidueCardTenFieldNumber = 16;
  inline ::google::protobuf::uint32 residue_card_ten() const;
  inline void set_residue_card_ten(::google::protobuf::uint32 value);

  // optional uint32 residue_card_hundred = 17;
  inline bool has_residue_card_hundred() const;
  inline void clear_residue_card_hundred();
  static const int kResidueCardHundredFieldNumber = 17;
  inline ::google::protobuf::uint32 residue_card_hundred() const;
  inline void set_residue_card_hundred(::google::protobuf::uint32 value);

  // repeated uint32 card_data_ten = 18;
  inline int card_data_ten_size() const;
  inline void clear_card_data_ten();
  static const int kCardDataTenFieldNumber = 18;
  inline ::google::protobuf::uint32 card_data_ten(int index) const;
  inline void set_card_data_ten(int index, ::google::protobuf::uint32 value);
  inline void add_card_data_ten(::google::protobuf::uint32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      card_data_ten() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_card_data_ten();

  // repeated uint32 card_data_hundred = 19;
  inline int card_data_hundred_size() const;
  inline void clear_card_data_hundred();
  static const int kCardDataHundredFieldNumber = 19;
  inline ::google::protobuf::uint32 card_data_hundred(int index) const;
  inline void set_card_data_hundred(int index, ::google::protobuf::uint32 value);
  inline void add_card_data_hundred(::google::protobuf::uint32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      card_data_hundred() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_card_data_hundred();

  // optional uint32 time_leave_ten = 20;
  inline bool has_time_leave_ten() const;
  inline void clear_time_leave_ten();
  static const int kTimeLeaveTenFieldNumber = 20;
  inline ::google::protobuf::uint32 time_leave_ten() const;
  inline void set_time_leave_ten(::google::protobuf::uint32 value);

  // optional uint32 time_leave_hundred = 21;
  inline bool has_time_leave_hundred() const;
  inline void clear_time_leave_hundred();
  static const int kTimeLeaveHundredFieldNumber = 21;
  inline ::google::protobuf::uint32 time_leave_hundred() const;
  inline void set_time_leave_hundred(::google::protobuf::uint32 value);

  // optional uint32 win_uid_ten = 22;
  inline bool has_win_uid_ten() const;
  inline void clear_win_uid_ten();
  static const int kWinUidTenFieldNumber = 22;
  inline ::google::protobuf::uint32 win_uid_ten() const;
  inline void set_win_uid_ten(::google::protobuf::uint32 value);

  // optional uint32 win_uid_hundred = 23;
  inline bool has_win_uid_hundred() const;
  inline void clear_win_uid_hundred();
  static const int kWinUidHundredFieldNumber = 23;
  inline ::google::protobuf::uint32 win_uid_hundred() const;
  inline void set_win_uid_hundred(::google::protobuf::uint32 value);

  // optional int64 win_score_ten = 24;
  inline bool has_win_score_ten() const;
  inline void clear_win_score_ten();
  static const int kWinScoreTenFieldNumber = 24;
  inline ::google::protobuf::int64 win_score_ten() const;
  inline void set_win_score_ten(::google::protobuf::int64 value);

  // optional int64 win_score_hundred = 25;
  inline bool has_win_score_hundred() const;
  inline void clear_win_score_hundred();
  static const int kWinScoreHundredFieldNumber = 25;
  inline ::google::protobuf::int64 win_score_hundred() const;
  inline void set_win_score_hundred(::google::protobuf::int64 value);
 ...
 private:
  ...
  inline void set_has_periods_num_ten();
  inline void clear_has_periods_num_ten();
  inline void set_has_periods_num_hundred();
  inline void clear_has_periods_num_hundred();
  inline void set_has_game_status_ten();
  inline void clear_has_game_status_ten();
  inline void set_has_game_status_hundred();
  inline void clear_has_game_status_hundred();
  inline void set_has_residue_card_ten();
  inline void clear_has_residue_card_ten();
  inline void set_has_residue_card_hundred();
  inline void clear_has_residue_card_hundred();
  inline void set_has_time_leave_ten();
  inline void clear_has_time_leave_ten();
  inline void set_has_time_leave_hundred();
  inline void clear_has_time_leave_hundred();
  inline void set_has_win_uid_ten();
  inline void clear_has_win_uid_ten();
  inline void set_has_win_uid_hundred();
  inline void clear_has_win_uid_hundred();
  inline void set_has_win_score_ten();
  inline void clear_has_win_score_ten();
  inline void set_has_win_score_hundred();
  inline void clear_has_win_score_hundred();
  ...
  ::std::string* periods_num_ten_;
  ::std::string* periods_num_hundred_;
  ::google::protobuf::uint32 game_status_ten_;
  ::google::protobuf::uint32 game_status_hundred_;
  ::google::protobuf::uint32 residue_card_ten_;
  ::google::protobuf::uint32 residue_card_hundred_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > card_data_ten_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > card_data_hundred_;
  ::google::protobuf::uint32 time_leave_ten_;
  ::google::protobuf::uint32 time_leave_hundred_;
  ::google::protobuf::uint32 win_uid_ten_;
  ::google::protobuf::uint32 win_uid_hundred_;
  ::google::protobuf::int64 win_score_ten_;
  ::google::protobuf::int64 win_score_hundred_;
...
// optional bytes periods_num_ten = 12;
inline bool msg_everycolor_game_info_play_rep::has_periods_num_ten() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_periods_num_ten() {
  _has_bits_[0] |= 0x00000800u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_periods_num_ten() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void msg_everycolor_game_info_play_rep::clear_periods_num_ten() {
  if (periods_num_ten_ != &::google::protobuf::internal::kEmptyString) {
    periods_num_ten_->clear();
  }
  clear_has_periods_num_ten();
}
inline const ::std::string& msg_everycolor_game_info_play_rep::periods_num_ten() const {
  return *periods_num_ten_;
}
inline void msg_everycolor_game_info_play_rep::set_periods_num_ten(const ::std::string& value) {
  set_has_periods_num_ten();
  if (periods_num_ten_ == &::google::protobuf::internal::kEmptyString) {
    periods_num_ten_ = new ::std::string;
  }
  periods_num_ten_->assign(value);
}
inline void msg_everycolor_game_info_play_rep::set_periods_num_ten(const char* value) {
  set_has_periods_num_ten();
  if (periods_num_ten_ == &::google::protobuf::internal::kEmptyString) {
    periods_num_ten_ = new ::std::string;
  }
...
inline void msg_everycolor_game_info_play_rep::set_periods_num_ten(const void* value, size_t size) {
  set_has_periods_num_ten();
  if (periods_num_ten_ == &::google::protobuf::internal::kEmptyString) {
    periods_num_ten_ = new ::std::string;
  }
  periods_num_ten_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* msg_everycolor_game_info_play_rep::mutable_periods_num_ten() {
  set_has_periods_num_ten();
  if (periods_num_ten_ == &::google::protobuf::internal::kEmptyString) {
    periods_num_ten_ = new ::std::string;
  }
...
inline ::std::string* msg_everycolor_game_info_play_rep::release_periods_num_ten() {
  clear_has_periods_num_ten();
  if (periods_num_ten_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
    ::std::string* temp = periods_num_ten_;
    periods_num_ten_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
inline void msg_everycolor_game_info_play_rep::set_allocated_periods_num_ten(::std::string* periods_num_ten) {
  if (periods_num_ten_ != &::google::protobuf::internal::kEmptyString) {
    delete periods_num_ten_;
  }
  if (periods_num_ten) {
    set_has_periods_num_ten();
    periods_num_ten_ = periods_num_ten;
  } else {
    clear_has_periods_num_ten();
    periods_num_ten_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
...
// optional bytes periods_num_hundred = 13;
inline bool msg_everycolor_game_info_play_rep::has_periods_num_hundred() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_periods_num_hundred() {
  _has_bits_[0] |= 0x00001000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_periods_num_hundred() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void msg_everycolor_game_info_play_rep::clear_periods_num_hundred() {
  if (periods_num_hundred_ != &::google::protobuf::internal::kEmptyString) {
    periods_num_hundred_->clear();
  }
  clear_has_periods_num_hundred();
}
inline const ::std::string& msg_everycolor_game_info_play_rep::periods_num_hundred() const {
  return *periods_num_hundred_;
}
inline void msg_everycolor_game_info_play_rep::set_periods_num_hundred(const ::std::string& value) {
  set_has_periods_num_hundred();
  if (periods_num_hundred_ == &::google::protobuf::internal::kEmptyString) {
    periods_num_hundred_ = new ::std::string;
  }
  periods_num_hundred_->assign(value);
}
inline void msg_everycolor_game_info_play_rep::set_periods_num_hundred(const char* value) {
  set_has_periods_num_hundred();
  if (periods_num_hundred_ == &::google::protobuf::internal::kEmptyString) {
    periods_num_hundred_ = new ::std::string;
  }
...
inline void msg_everycolor_game_info_play_rep::set_periods_num_hundred(const void* value, size_t size) {
  set_has_periods_num_hundred();
  if (periods_num_hundred_ == &::google::protobuf::internal::kEmptyString) {
    periods_num_hundred_ = new ::std::string;
  }
  periods_num_hundred_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* msg_everycolor_game_info_play_rep::mutable_periods_num_hundred() {
  set_has_periods_num_hundred();
  if (periods_num_hundred_ == &::google::protobuf::internal::kEmptyString) {
    periods_num_hundred_ = new ::std::string;
  }
...
inline ::std::string* msg_everycolor_game_info_play_rep::release_periods_num_hundred() {
  clear_has_periods_num_hundred();
  if (periods_num_hundred_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
    ::std::string* temp = periods_num_hundred_;
    periods_num_hundred_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
inline void msg_everycolor_game_info_play_rep::set_allocated_periods_num_hundred(::std::string* periods_num_hundred) {
  if (periods_num_hundred_ != &::google::protobuf::internal::kEmptyString) {
    delete periods_num_hundred_;
  }
  if (periods_num_hundred) {
    set_has_periods_num_hundred();
    periods_num_hundred_ = periods_num_hundred;
  } else {
    clear_has_periods_num_hundred();
    periods_num_hundred_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
...
// optional uint32 game_status_ten = 14;
inline bool msg_everycolor_game_info_play_rep::has_game_status_ten() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_game_status_ten() {
  _has_bits_[0] |= 0x00002000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_game_status_ten() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void msg_everycolor_game_info_play_rep::clear_game_status_ten() {
  game_status_ten_ = 0u;
  clear_has_game_status_ten();
}
inline ::google::protobuf::uint32 msg_everycolor_game_info_play_rep::game_status_ten() const {
  return game_status_ten_;
}
inline void msg_everycolor_game_info_play_rep::set_game_status_ten(::google::protobuf::uint32 value) {
  set_has_game_status_ten();
  game_status_ten_ = value;
}

// optional uint32 game_status_hundred = 15;
inline bool msg_everycolor_game_info_play_rep::has_game_status_hundred() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_game_status_hundred() {
  _has_bits_[0] |= 0x00004000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_game_status_hundred() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void msg_everycolor_game_info_play_rep::clear_game_status_hundred() {
  game_status_hundred_ = 0u;
  clear_has_game_status_hundred();
}
inline ::google::protobuf::uint32 msg_everycolor_game_info_play_rep::game_status_hundred() const {
  return game_status_hundred_;
}
inline void msg_everycolor_game_info_play_rep::set_game_status_hundred(::google::protobuf::uint32 value) {
  set_has_game_status_hundred();
  game_status_hundred_ = value;
}

// optional uint32 residue_card_ten = 16;
inline bool msg_everycolor_game_info_play_rep::has_residue_card_ten() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_residue_card_ten() {
  _has_bits_[0] |= 0x00008000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_residue_card_ten() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void msg_everycolor_game_info_play_rep::clear_residue_card_ten() {
  residue_card_ten_ = 0u;
  clear_has_residue_card_ten();
}
inline ::google::protobuf::uint32 msg_everycolor_game_info_play_rep::residue_card_ten() const {
  return residue_card_ten_;
}
inline void msg_everycolor_game_info_play_rep::set_residue_card_ten(::google::protobuf::uint32 value) {
  set_has_residue_card_ten();
  residue_card_ten_ = value;
}

// optional uint32 residue_card_hundred = 17;
inline bool msg_everycolor_game_info_play_rep::has_residue_card_hundred() const {
  return (_has_bits_[0] & 0x00010000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_residue_card_hundred() {
  _has_bits_[0] |= 0x00010000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_residue_card_hundred() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void msg_everycolor_game_info_play_rep::clear_residue_card_hundred() {
  residue_card_hundred_ = 0u;
  clear_has_residue_card_hundred();
}
inline ::google::protobuf::uint32 msg_everycolor_game_info_play_rep::residue_card_hundred() const {
  return residue_card_hundred_;
}
inline void msg_everycolor_game_info_play_rep::set_residue_card_hundred(::google::protobuf::uint32 value) {
  set_has_residue_card_hundred();
  residue_card_hundred_ = value;
}

// repeated uint32 card_data_ten = 18;
inline int msg_everycolor_game_info_play_rep::card_data_ten_size() const {
  return card_data_ten_.size();
}
inline void msg_everycolor_game_info_play_rep::clear_card_data_ten() {
  card_data_ten_.Clear();
}
inline ::google::protobuf::uint32 msg_everycolor_game_info_play_rep::card_data_ten(int index) const {
  return card_data_ten_.Get(index);
}
inline void msg_everycolor_game_info_play_rep::set_card_data_ten(int index, ::google::protobuf::uint32 value) {
  card_data_ten_.Set(index, value);
}
inline void msg_everycolor_game_info_play_rep::add_card_data_ten(::google::protobuf::uint32 value) {
  card_data_ten_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
msg_everycolor_game_info_play_rep::card_data_ten() const {
  return card_data_ten_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
msg_everycolor_game_info_play_rep::mutable_card_data_ten() {
  return &card_data_ten_;
}

// repeated uint32 card_data_hundred = 19;
inline int msg_everycolor_game_info_play_rep::card_data_hundred_size() const {
  return card_data_hundred_.size();
}
inline void msg_everycolor_game_info_play_rep::clear_card_data_hundred() {
  card_data_hundred_.Clear();
}
inline ::google::protobuf::uint32 msg_everycolor_game_info_play_rep::card_data_hundred(int index) const {
  return card_data_hundred_.Get(index);
}
inline void msg_everycolor_game_info_play_rep::set_card_data_hundred(int index, ::google::protobuf::uint32 value) {
  card_data_hundred_.Set(index, value);
}
inline void msg_everycolor_game_info_play_rep::add_card_data_hundred(::google::protobuf::uint32 value) {
  card_data_hundred_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
msg_everycolor_game_info_play_rep::card_data_hundred() const {
  return card_data_hundred_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
msg_everycolor_game_info_play_rep::mutable_card_data_hundred() {
  return &card_data_hundred_;
}

// optional uint32 time_leave_ten = 20;
inline bool msg_everycolor_game_info_play_rep::has_time_leave_ten() const {
  return (_has_bits_[0] & 0x00080000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_time_leave_ten() {
  _has_bits_[0] |= 0x00080000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_time_leave_ten() {
  _has_bits_[0] &= ~0x00080000u;
}
inline void msg_everycolor_game_info_play_rep::clear_time_leave_ten() {
  time_leave_ten_ = 0u;
  clear_has_time_leave_ten();
}
inline ::google::protobuf::uint32 msg_everycolor_game_info_play_rep::time_leave_ten() const {
  return time_leave_ten_;
}
inline void msg_everycolor_game_info_play_rep::set_time_leave_ten(::google::protobuf::uint32 value) {
  set_has_time_leave_ten();
  time_leave_ten_ = value;
}

// optional uint32 time_leave_hundred = 21;
inline bool msg_everycolor_game_info_play_rep::has_time_leave_hundred() const {
  return (_has_bits_[0] & 0x00100000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_time_leave_hundred() {
  _has_bits_[0] |= 0x00100000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_time_leave_hundred() {
  _has_bits_[0] &= ~0x00100000u;
}
inline void msg_everycolor_game_info_play_rep::clear_time_leave_hundred() {
  time_leave_hundred_ = 0u;
  clear_has_time_leave_hundred();
}
inline ::google::protobuf::uint32 msg_everycolor_game_info_play_rep::time_leave_hundred() const {
  return time_leave_hundred_;
}
inline void msg_everycolor_game_info_play_rep::set_time_leave_hundred(::google::protobuf::uint32 value) {
  set_has_time_leave_hundred();
  time_leave_hundred_ = value;
}

// optional uint32 win_uid_ten = 22;
inline bool msg_everycolor_game_info_play_rep::has_win_uid_ten() const {
  return (_has_bits_[0] & 0x00200000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_win_uid_ten() {
  _has_bits_[0] |= 0x00200000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_win_uid_ten() {
  _has_bits_[0] &= ~0x00200000u;
}
inline void msg_everycolor_game_info_play_rep::clear_win_uid_ten() {
  win_uid_ten_ = 0u;
  clear_has_win_uid_ten();
}
inline ::google::protobuf::uint32 msg_everycolor_game_info_play_rep::win_uid_ten() const {
  return win_uid_ten_;
}
inline void msg_everycolor_game_info_play_rep::set_win_uid_ten(::google::protobuf::uint32 value) {
  set_has_win_uid_ten();
  win_uid_ten_ = value;
}

// optional uint32 win_uid_hundred = 23;
inline bool msg_everycolor_game_info_play_rep::has_win_uid_hundred() const {
  return (_has_bits_[0] & 0x00400000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_win_uid_hundred() {
  _has_bits_[0] |= 0x00400000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_win_uid_hundred() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void msg_everycolor_game_info_play_rep::clear_win_uid_hundred() {
  win_uid_hundred_ = 0u;
  clear_has_win_uid_hundred();
}
inline ::google::protobuf::uint32 msg_everycolor_game_info_play_rep::win_uid_hundred() const {
  return win_uid_hundred_;
}
inline void msg_everycolor_game_info_play_rep::set_win_uid_hundred(::google::protobuf::uint32 value) {
  set_has_win_uid_hundred();
  win_uid_hundred_ = value;
}

// optional int64 win_score_ten = 24;
inline bool msg_everycolor_game_info_play_rep::has_win_score_ten() const {
  return (_has_bits_[0] & 0x00800000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_win_score_ten() {
  _has_bits_[0] |= 0x00800000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_win_score_ten() {
  _has_bits_[0] &= ~0x00800000u;
}
inline void msg_everycolor_game_info_play_rep::clear_win_score_ten() {
  win_score_ten_ = GOOGLE_LONGLONG(0);
  clear_has_win_score_ten();
}
inline ::google::protobuf::int64 msg_everycolor_game_info_play_rep::win_score_ten() const {
  return win_score_ten_;
}
inline void msg_everycolor_game_info_play_rep::set_win_score_ten(::google::protobuf::int64 value) {
  set_has_win_score_ten();
  win_score_ten_ = value;
}

// optional int64 win_score_hundred = 25;
inline bool msg_everycolor_game_info_play_rep::has_win_score_hundred() const {
  return (_has_bits_[0] & 0x01000000u) != 0;
}
inline void msg_everycolor_game_info_play_rep::set_has_win_score_hundred() {
  _has_bits_[0] |= 0x01000000u;
}
inline void msg_everycolor_game_info_play_rep::clear_has_win_score_hundred() {
  _has_bits_[0] &= ~0x01000000u;
}
inline void msg_everycolor_game_info_play_rep::clear_win_score_hundred() {
  win_score_hundred_ = GOOGLE_LONGLONG(0);
  clear_has_win_score_hundred();
}
inline ::google::protobuf::int64 msg_everycolor_game_info_play_rep::win_score_hundred() const {
  return win_score_hundred_;
}
inline void msg_everycolor_game_info_play_rep::set_win_score_hundred(::google::protobuf::int64 value) {
  set_has_win_score_hundred();
  win_score_hundred_ = value;
}
