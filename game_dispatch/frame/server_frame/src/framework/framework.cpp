...
void CFrameWork::SetNormalLogConf(string name,int level,int MaxFileLen,int delDays)
{
	...
	//std::string strLogFileName = CStringUtility::FormatToString("%d_%s", GetServerID(), name.c_str());
	//log_constructor_logger(strLogFileName.c_str());
...
void CFrameWork::UpdateLog()
{
	...
	//string logName = "server_data";
	//int loglv = 3;
	//int logsize = 52428800;
	//int logdays = 5;
	//SetNormalLogConf(logName, loglv, logsize, logdays);
