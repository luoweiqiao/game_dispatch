...
public:
	...
	// 设置用户水果机库存 
	//bool    SetStockScore(int64 nStockScore);
	// 设置用户水果机库存 
	//int64    ChangeStockScore(int64 nStockScore);
...
protected:
	...
	uint32 GetPlayerPayStatus(int32 iPayStatus, int64 lPayRecharge);
