...
void CNiuNiuLogic::SetTable(CGameNiuniuTable* pTable)
{
	m_pHostTable = pTable;
}
...
bool CNiuNiuLogic::RandUpsetCardData(BYTE cbCardBuffer[], BYTE cbBufferCount)
{
...
*/
//Multiple 比较出来的倍数
int CNiuNiuLogic::CompareCard(const BYTE cbFirstCardData[], BYTE cbFirstCardCount,const BYTE cbNextCardData[], BYTE cbNextCardCount,BYTE &Multiple)
{
	//合法判断
	ASSERT(NIUNIU_CARD_NUM ==cbFirstCardCount && NIUNIU_CARD_NUM ==cbNextCardCount);
	if (!(NIUNIU_CARD_NUM == cbFirstCardCount && NIUNIU_CARD_NUM == cbNextCardCount))
	{
		return 0;
	}
...
bool CNiuNiuLogic::GetCardTypeData(int iArProCardType[], BYTE cbArCardData[][NIUNIU_CARD_NUM])
{
	...
	for (int i = 0; i < GAME_PLAYER; i++)
	{
		...
		{
			bIsFlag = GetTypePoint(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIU1)
		{
			bIsFlag = GetTypeNiuOne(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIU2)
		{
			bIsFlag = GetTypeNiuTwo(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIU3)
		{
			bIsFlag = GetTypeNiuThree(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIU4)
		{
			bIsFlag = GetTypeNiuFour(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIU5)
		{
			bIsFlag = GetTypeNiuFive(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIU6)
		{
			bIsFlag = GetTypeNiuSix(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIU7)
		{
			bIsFlag = GetTypeNiuSeven(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIU8)
		{
			bIsFlag = GetTypeNiuEight(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIU9)
		{
			bIsFlag = GetTypeNiuNine(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIUNIU)
		{
			bIsFlag = GetTypeNiuNiu(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIUNIUDW)
		{
			bIsFlag = GetTypeNiuBig_5(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_NIUNIUXW)
		{
			bIsFlag = GetTypeNiuSmall_5(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		else if (iArTempProCardType[i] == CT_SPECIAL_BOMEBOME)
		{
			bIsFlag = GetTypeBome(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
		}
		...
		if (bIsFlag)
		{
			...
			for (int p0 = 0; p0 < NIUNIU_CARD_NUM; p0++)
			{
				for (int p1 = 0; p1 < NIUNIU_CARD_NUM; p1++)
				{
					if (p0!=p1)
					{
			...
			{
				for (int c1 = 0; c1 < NIUNIU_CARD_NUM; c1++)
				{
	...
	for (int i = 0; i < GAME_PLAYER; i++)
	{
		...
		{
			bool bIsFlag = GetTypeRand(cbCardListData, CARD_COUNT, cbArTempCardData[i], NIUNIU_CARD_NUM);
...
//获取点数类型
bool CNiuNiuLogic::GetTypePoint(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	// 统计剩余扑克
	...
	int iLoopIndex = 0;
	BYTE cbTargetCard[NIUNIU_CARD_NUM] = { 0 };
...
bool CNiuNiuLogic::GetTripleCardDataHasTenTimes(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	// 获取剩余扑克
...
//获取牛一
bool CNiuNiuLogic::GetTypeNiuOne(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	// 有可能有 1 的最后两个扑克牌
	// 2-9
	// 3-8
...
//获取牛二
bool CNiuNiuLogic::GetTypeNiuTwo(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//3-9
	//4-8
	//5-7
...
//获取牛三
bool CNiuNiuLogic::GetTypeNiuThree(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//1-2
	//4-9
	//5-8
...
//获取牛四
bool CNiuNiuLogic::GetTypeNiuFour(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//1-3
	//5-9
	//6-8
...
//获取牛五
bool CNiuNiuLogic::GetTypeNiuFive(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//1-4
	//2-3
	//6-9
...
//获取牛六
bool CNiuNiuLogic::GetTypeNiuSix(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//1-5
	//2-4
	//7-9
...
//获取牛七
bool CNiuNiuLogic::GetTypeNiuSeven(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//1-6
	//2-5
	//3-4
...
//获取牛八
bool CNiuNiuLogic::GetTypeNiuEight(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//1-7
	//2-6
	//3-5
...
//获取牛九
bool CNiuNiuLogic::GetTypeNiuNine(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//1-8
	//2-7
	//3-6
	...
	for (int i = 0; i < 4; i++)
	{
		if (vecAllDigitCardSmall[i].size()>0 && vecAllDigitCardBig[i].size() > 0)
		{
			...
			//LOG_DEBUG("Merge  - roomid:%d,tableid:%d,first:0x%02X:second:0x%02X",
			//	m_pHostTable->GetRoomID(), m_pHostTable->GetTableID(), tempPairCard.first,tempPairCard.second);
	...
	//LOG_DEBUG("rand  - roomid:%d,tableid:%d,cbRandMergeIndex:%d,first:0x%02X:second:0x%02X",
	//	m_pHostTable->GetRoomID(), m_pHostTable->GetTableID(), cbRandMergeIndex,vecAllDigitCardMerge[cbRandMergeIndex].first, vecAllDigitCardMerge[cbRandMergeIndex].second);
...
//获取牛牛
bool CNiuNiuLogic::GetTypeNiuNiu(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
...
//获取大五牛
bool CNiuNiuLogic::GetTypeNiuBig_5(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	BYTE cbTempListCount = 0;
	BYTE cbArTempCardData[CARD_COUNT] = { 0 };
	for (BYTE i = 0; i < cbListCount; i++)
...
//获取小五牛
bool CNiuNiuLogic::GetTypeNiuSmall_5(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
...
//获取炸弹
bool CNiuNiuLogic::GetTypeBome(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	BYTE cbTempListCount = 0;
	BYTE cbArTempCardData[CARD_COUNT] = { 0 };
	for (BYTE i = 0; i < cbListCount; i++)
...
//获取随机牌
bool CNiuNiuLogic::GetTypeRand(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	BYTE cbTempListCount = 0;
	BYTE cbArTempCardData[CARD_COUNT] = { 0 };
	for (BYTE i = 0; i < cbListCount; i++)
